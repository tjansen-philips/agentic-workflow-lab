...
Previous: [Step 1 — Explore the Context Engineering Setup](./step-01-explore-context.md)  
Next: [Step 3 — Create an Implementation Plan](./step-03-create-implementation-plan.md)