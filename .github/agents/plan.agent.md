...
This planning agent is for demo lab purposes, so keep the plans simple and avoid overengineering.
...
2. Structure the plan: Use the provided [implementation plan template](../../docs/plan-template.md) to structure the plan.
